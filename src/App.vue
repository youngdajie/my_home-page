<template>
	...
	<div class="dark_none min_1176_none left_logo_center">
		<img src="/src/assets/images/logo.webp" alt="logo" title="logo" class="left_logo_center_img">
	</div>
...
.left_logo_center_img {
	width: 88px;
	border-radius: 25%;
	box-shadow: 0 2px 8px #00000033;
	padding: 5px;
	border: 3px solid #c1c1c180;
}

/* .left_logo_center_yang2s {
	border-radius: 25%;
